...
import com.tracktainment.bookmanager.dataprovider.DuxManagerDataProviderRest;
...
class DuxManagerDataProviderRestTest {
    ...
    void setUp() {
        ...
        assetRequest = TestBookDataUtil.createTestAssetRequest(UUID.randomUUID().toString());
        assetResponse1 = TestBookDataUtil.createTestAssetResponse();
        assetResponse2 = TestBookDataUtil.createTestAssetResponse();
    }
    ...
    void shouldFindAssetsByCriteriaWithAllParameters() {
        ...
        String artifactId = "book-manager";
        String type = "book";
    ...
    void shouldFindAssetsByExternalId() {
        ...
        // Act
        List<AssetResponse> results = duxManagerDataProviderRest.findAssetsByCriteria(
                jwt, digitalUserId, externalId, "com.tracktainment", "book-manager", "book",
                null, null, null);
    ...
    void shouldFindAssetsByDateRange() {
        ...
        // Act
        List<AssetResponse> results = duxManagerDataProviderRest.findAssetsByCriteria(
                jwt, digitalUserId, null, "com.tracktainment", "book-manager", "book",
                null, from, to);
    ...
    void shouldDeleteAssetSuccessfully() {
        ...
        // Act
        duxManagerDataProviderRest.deleteAssetByExternalId(jwt, digitalUserId, externalId);
