...
import com.tracktainment.bookmanager.exception.*;
...
class ExceptionMapperEntryPointRestTest {
    ...
    private final ExceptionMapperEntryPointRest mapper = Mappers.getMapper(ExceptionMapperEntryPointRest.class);

    @Test
    void shouldMapResourceNotFoundException() {
        // Arrange
        String resourceId = UUID.randomUUID().toString();
        ResourceNotFoundException exception = new ResourceNotFoundException(Book.class, resourceId);
        ...
        assertEquals(String.format("Book %s not found.", resourceId), result.getMessage());
    ...
    void shouldMapResourceAlreadyExistsException() {
        // Arrange
        String resourceId = UUID.randomUUID().toString();
        ResourceAlreadyExistsException exception = new ResourceAlreadyExistsException(Book.class, resourceId);
        ...
        assertEquals(String.format("Book %s already exists.", resourceId), result.getMessage());
